...
<div class="detail-layout">
    <div class="detail-left">
        ...
        <div class="card">
            <form method="POST" action="{{ route('keranjang.tambah', $tool->id_alat) }}" class="cart-add-form">
                @csrf
    ...
    <div class="detail-right">
        <div class="card">
            <form method="GET" action="{{ route('katalog.show', $tool->id_alat) }}">
                <div class="card" style="padding:12px 16px;margin-bottom:12px">
                    <div class="search-box" style="display:flex;gap:8px;align-items:center">
                        ...
                        @if(request('search'))
                        <a href="{{ route('katalog.show', $tool->id_alat) }}" style="color:#9CA3AF;font-size:12px;text-decoration:none">&times;</a>
                        @endif
                    </div>
                </div>
            </form>
