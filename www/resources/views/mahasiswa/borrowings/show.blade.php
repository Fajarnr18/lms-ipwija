...
@section('content')
<a href="{{ route('mhs.borrowings.index') }}" class="btn btn-outline btn-sm mb-3">&larr; Kembali</a>
...
<div class="card">
    ...
    <div class="grid-2">
        ...
        <div class="form-group"><label>Tgl Dikembalikan</label><span>{{ $borowing->tgl_pengembalian_aktual?->format('d/m/Y H:i') }}</span></div>
        @endif
    </div>
</div>
