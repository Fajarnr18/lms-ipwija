...
@else
<form method="POST" action="{{ route('keranjang.ajukan') }}" id="cartForm">
    @csrf
            ...
            <table class="cart-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center">
                            <a href="{{ route('keranjang.hapus', $id) }}" class="hapus-link" onclick="event.preventDefault(); hapusItem('{{ route('keranjang.hapus', $id) }}', '{{ $item['nama_alat'] }}')">Hapus</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
