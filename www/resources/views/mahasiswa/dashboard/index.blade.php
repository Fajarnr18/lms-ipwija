...
<span class="badge badge-blue" style="font-size:11px;vertical-align:middle;margin-left:8px">Mahasiswa</span>
@endsection
        ...
        <div class="card" style="margin-bottom:12px">
            <div style="display:flex;gap:16px">
                ...
                <div style="flex:1;min-width:0">
                    ...
                    <div style="text-align:right">
                        <a href="{{ route('peminjaman.detail', $ab->id_borrowing) }}" style="font-size:12px;color:#3B82F6;text-decoration:none;font-weight:600">Detail Peminjaman &rarr;</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div>
        ...
        <div class="card" style="background:linear-gradient(135deg,#1E3A5F,#162D4D);border:none;margin-top:20px;padding:20px">
            <div style="text-align:center">
                ...
                <a href="{{ route('katalog.index') }}" style="display:inline-flex;align-items:center;gap:8px;padding:10px 20px;background:#3B82F6;color:#fff;border-radius:8px;font-size:13px;font-weight:600;text-decoration:none">
