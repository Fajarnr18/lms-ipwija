...
<div class="main-grid">
    ...
    <div class="right-col">
        <a href="{{ route('dosen.peminjaman.pdf', $borowing->id_borrowing) }}" class="download-btn">
        ...
        <div class="section-card" style="padding:24px;">
            ...
            <ul class="instruction-list">
                ...
                <li>
                    ...
                    <div>Lakukan verifikasi identitas (Pegawai/KTP) sebelum serah terima alat.</div>
                </li>
                <li>
        ...
        <a href="{{ route('dosen.peminjaman.index') }}" style="display:block; text-align:center; padding:12px; border:1px solid #E5E7EB; border-radius:8px; font-size:13px; font-weight:600; color:#4B5563; text-decoration:none; background:#fff;">
            &larr; Kembali
        </a>
    </div>
</div>
