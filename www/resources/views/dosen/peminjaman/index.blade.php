...
<div class="tabs-container">
    <a href="{{ route('dosen.peminjaman.index') }}" class="tab-item {{ !request('status') || request('status') == 'SEMUA' ? 'active' : '' }}">Semua</a>
    <a href="{{ route('dosen.peminjaman.index', ['status' => 'MENUNGGU']) }}" class="tab-item {{ request('status') == 'MENUNGGU' ? 'active' : '' }}">Menunggu</a>
    <a href="{{ route('dosen.peminjaman.index', ['status' => 'DISETUJUI']) }}" class="tab-item {{ request('status') == 'DISETUJUI' ? 'active' : '' }}">Disetujui</a>
    <a href="{{ route('dosen.peminjaman.index', ['status' => 'DIPINJAM']) }}" class="tab-item {{ request('status') == 'DIPINJAM' ? 'active' : '' }}">Dipinjam</a>
    <a href="{{ route('dosen.peminjaman.index', ['status' => 'DIKEMBALIKAN']) }}" class="tab-item {{ request('status') == 'DIKEMBALIKAN' ? 'active' : '' }}">Dikembalikan</a>
    <a href="{{ route('dosen.peminjaman.index', ['status' => 'DITOLAK']) }}" class="tab-item {{ request('status') == 'DITOLAK' ? 'active' : '' }}">Ditolak</a>
</div>
    ...
    <table class="custom-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('dosen.peminjaman.detail', $b->id_borrowing) }}" class="btn-detail">
                        Lihat Detail
...
<div class="info-box">
    ...
    <div>
        ...
        <div class="info-desc">
            Harap membawa Kartu Identitas (KTP/Pegawai) asli saat melakukan pengambilan alat di laboratorium. Pastikan alat dikembalikan sesuai jadwal untuk menghindari denda keterlambatan.
        </div>
    </div>
</div>
@endsection
